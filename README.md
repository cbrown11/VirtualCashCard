...
At moment this only covers the command and the eventstore.
...
1. Use Greg Young’s database for the event sourcing. Instead of In memory EventStore. Switchable via config file.
